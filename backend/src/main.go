...
func main() {
	...
	authApis.HandleFunc("/live/{liveId}/order-list", api.LiveOrders).Methods("GET", "OPTIONS")
	...
	// TEST API path
	r.HandleFunc(prodRoutePrefix+"test/echo", test.EchoString).Methods("GET", "OPTIONS")
